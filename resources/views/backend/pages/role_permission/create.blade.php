...
@section('title', 'Create Role | Permission Management')
...
@section('content')
    ...
    <div class="card shadow-sm p-4">
        <form id="roleForm" action="{{ route('permission.role.store') }}" method="POST" novalidate>
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="serial_no" id="serial_no" class="form-control" placeholder="Enter serial number" value="{{ old('serial_no') }}">
